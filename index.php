...
#cl:hover{color: #fff}
#x3:hover{background-color:#3CB371;color: #fff}
</style>
<script>
...
<script type="text/javascript" src="web/js/send_request.js"></script>
...
<body>
	...
	<div class="header">
		<div class="container">
			<div class="top-header">
				...
				<div class="queries">
					...
					{
						echo "<img  src='user_images/user_default_image.jpg'  onMouseOver=showmenu('dropdown') onMouseOut=hidemenu('dropdown') width='70' height='50' alt='user'  >";
						echo "<div id='dropdown' style='visibility:hidden ' onMouseOver=showmenu('dropdown') onMouseOut=hidemenu('dropdown')><table style='width:100px;height:30px;border:solid 1px #3CB371;border-radius: 10px'><tr ><td style='padding:3px; ' class='menu' id='x3'><a href='#' id='cl' >Transaction</a> </td></tr><tr><td style='padding:3px;' class='menu' id='x3'><a href='logout.php' id='cl' >LogOut</a></td></tr></table></div>";
					}
					else{
					 echo "<a id='modal_trigger' href='#modal' class='btn'>Login/Signup</a>";
					}
					?>
					<div id="modal" class="popupContainer" style="display:none; margin-top:-100px !important;">
		...
		<section class="popupBody">
			...
			<div class="user_login">
				<form action="php/check_login.php" method="post">
					...
					<div class="action_btns">
						...
						<input class="one_half last"type="submit" name="submit" value="submit"/><a class="btn btn_red">Login</a>
					</div>
				</form>
			...
			<div class="user_register">
				<form action="php/user_add1.php" method="post">
					...
					<div class="action_btns">
						<div class="one_half"><a href="#" class="btn back_btn"><i class="fa fa-angle-double-left"></i> Back</a></div>
						<input class="one_half last"type="submit" name="submit" value="submit"/>Register</a>
					</div>
				</form>
			</div>
		</section>
	...
	$(function(){
					...
					<div class="form-list wow fadeInRight" data-wow-delay="0.5s">
						<form>
						  <ul class="navmain">
							...
							<li><span>Select Area</span>
							 <select id="select_area" name="area">
                                <option>Select Area</option>
                                 <option value="malviya_nagar">Malviya Nagar</option>
                                 <option value="tonk_phatak">Tonk Phatak</option>
                                 <option value="ajmeri_gate">Ajmeri Gate</option>
                                 <option value="shastri_nagar">Shastri Nagar</option>
                                </select>
							</li>
							<li><span>Select Hobby</span>
	    ...
	    <div class="srch"><button onclick="send_req();"></button></div>
